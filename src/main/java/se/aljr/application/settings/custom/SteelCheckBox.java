...
public class SteelCheckBox extends javax.swing.JCheckBox
{
    ...
    private se.aljr.application.settings.tools.ColorDef selectedColor = se.aljr.application.settings.tools.ColorDef.JUG_GREEN;
    ...
    public se.aljr.application.settings.tools.ColorDef getSelectedColor()
    {
        return this.selectedColor;
    }

    public void setSelectedColor(final se.aljr.application.settings.tools.ColorDef SELECTED_COLOR)
    {
        final se.aljr.application.settings.tools.ColorDef OLD_COLOR = this.selectedColor;
